...
.desktopVersion .content form select {
  width: 100%;
...
.desktopVersion .donationWay h3 {
  font-family: 'Montserrat', sans-serif;
  font-weight: medium;
  font-size: 2em;
}

.desktopVersion .donationWay span{
  font-weight: bold;
  color: #5E23A9;
  cursor: pointer;
}

.desktopVersion .donationWay a{
    text-decoration: none;
  }

.desktopVersion .donationWay img{
  width: 10vw;
  margin-left: 40%;
}
